...
export default function NotificationCategories() {
    ...
    const deleteCategory = (id) => {
        apiClient
            .delete(`/notification-categories/${id}`)
            .then((res) => {
                UIkit.notification({
                    message:
    ...
    const handleViewService = (id) => {
        navigate(`/service-partner/editnotification-categories/${id}`); // Redirect to second page with blog ID in URL
    };
            ...
            <div id="sc-page-wrapper">
                <div id="sc-page-content">
                    <div className="uk-flex uk-flex-between uk-flex-middle">
                        ...
                        <Link to="/service-partner/addnotification-categories">
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            <div className="uk-flex gap-2">
                                                                <div>
                                                                    <Link
                                                                        to={`/service-partner/view-notification-categories/${value._id}`}
