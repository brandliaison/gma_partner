...
export default function Products() {
    ...
    const handleViewService = (id) => {
        navigate(`/service-partner/editproducts/${id}`); // Redirect to second page with blog ID in URL
    };
            ...
            <div id="sc-page-wrapper">
                <div id="sc-page-content">
                    <div className="uk-flex uk-flex-right">
                        <Link to="/service-partner/addproducts">
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            <div className="uk-flex gap-2">
                                                                <div>
                                                                    <Link
                                                                        to={`/service-partner/view-product/${value._id}`}
