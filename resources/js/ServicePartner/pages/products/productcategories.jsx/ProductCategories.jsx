...
export default function ProductCategories() {
  ...
  const handleViewService = (id) => {
    navigate(`/service-partner/editproduct-categories/${id}`); // Redirect to second page with blog ID in URL
  };
      ...
      <div id="sc-page-wrapper">
        <div id="sc-page-content">
          <div className="uk-flex uk-flex-between uk-flex-middle">
            ...
            <Link to="/service-partner/addproduct-categories">
                    ...
                    {categories?.data?.length > 0 ? (
                      categories?.data?.map((value, index) => (
                        <tr key={index}>
                          ...
                          <td className="uk-text-capitalize">{value.status}</td>
                          <td className="uk-text-capitalize">{value.approval_status}</td>
                          <td>
                            <div className="uk-flex gap-2">
                              <div>
                                <Link
                                  to={`/service-partner/view-product-category/${value._id}`}
