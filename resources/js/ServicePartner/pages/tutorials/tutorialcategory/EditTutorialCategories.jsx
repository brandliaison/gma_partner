...
export default function EditTutorialCategories() {
    ...
    const edittutorialcategory = () => {
        apiClient
            .get(`/tutorial-videos-categories/${id}`)
            .then((res) => {
    ...
    const handleSubmit = (e) => {
        ...
        // API Call
        apiClient
            .post(`/tutorial-videos-categories/${id}`, data, {
            ...
            .then((response) => {
                ...
                navigate("/service-partner/tutorials-categories");
            })
            .catch((error) => {
                            ...
                            <div className="uk-card">
                                <div className="uk-card-body">
                                    <h5 className="uk-heading-line">
                                        <span>Add Tutorial Category</span>
                                    </h5>
                                            ...
                                            >
                                                <div>
                                                    <input
                                                        ...
                                                        value={formData.name}
                                                        placeholder="Tutorial Category Name"
                                                        data-sc-input
                                                    />
                                                </div>
                                                <div>
                                                    <input
                                                        ...
                                                        placeholder="Tutorial Category Title"
                                                        data-sc-input
                                                    />
                                                </div>
                                            </div>
