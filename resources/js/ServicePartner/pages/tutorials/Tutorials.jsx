...
export default function Tutorials() {
    ...
    const handleViewBlog = (id) => {
        navigate(`/service-partner/edittutorials/${id}`); // Redirect to second page with blog ID in URL
    };
            ...
            <div id="sc-page-wrapper">
                <div id="sc-page-content">
                    <div className="uk-flex uk-flex-right">
                        <Link to="/service-partner/addtutorials">
                            <button
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <div className="uk-flex gap-2">
                                                            <div>
                                                                <Link
                                                                    to={`/service-partner/view-tutorials/${value._id}`}
