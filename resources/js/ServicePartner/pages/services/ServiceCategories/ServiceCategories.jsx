...
export default function ServiceCategories() {
    ...
    const handleViewService = (id) => {
        navigate(`/service-partner/edit-service-category/${id}`); // Redirect to second page with blog ID in URL
    };
            ...
            <div id="sc-page-wrapper">
                <div id="sc-page-content">
                    <div className="uk-flex uk-flex-between uk-flex-middle">
                        ...
                        <Link to="/service-partner/add-service-categories">
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            <div className="uk-flex gap-2">
                                                                <div>
                                                                    <Link
                                                                        to={`/service-partner/view-service-category/${value._id}`}
