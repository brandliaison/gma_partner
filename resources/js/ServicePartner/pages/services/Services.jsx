...
export default function Services() {
    ...
    const handleViewService = (id) => {
        navigate(`/service-partner/editservices/${id}`); // Redirect to second page with blog ID in URL
    };
            ...
            <div id="sc-page-wrapper">
                <div id="sc-page-content">
                    <div className="uk-flex uk-flex-right">
                        <Link to="/service-partner/addservices">
                                                ...
                                                <tr key={index}>
                                                    ...
                                                    <td>
                                                        <div className="uk-flex gap-2">
                                                            <div>
                                                                <Link
                                                                    to={`/service-partner/view-service/${value._id}`}
